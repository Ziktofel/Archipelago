...
from ..item import (
    parent_names,
    ItemData, TerranItemType, FactionlessItemType, ProtossItemType, ZergItemType, ItemVariantData
)
...
item_table = {
    ...
    item_names.REAVER_RESOURCE_EFFICIENCY: ItemData(345 + SC2LOTV_ITEM_ID_OFFSET, ProtossItemType.Forge_3, 15, SC2Race.PROTOSS, parent=item_names.REAVER),
...
v3_variant_item_data = {
    item_names.GHOST_RESOURCE_EFFICIENCY: ItemVariantData(TerranItemType.Variants, 0),
    item_names.SPECTRE_RESOURCE_EFFICIENCY: ItemVariantData(TerranItemType.Variants, 1),
    item_names.DESTROYER_REFORGED_BLOODSHARD_CORE: ItemVariantData(ProtossItemType.Variants, 0),
    item_names.ORACLE_STASIS_CALIBRATION: ItemVariantData(ProtossItemType.Variants, 1),
    item_names.REAVER_RESOURCE_EFFICIENCY: ItemVariantData(ProtossItemType.Variants, 2),
    item_names.SCOUT_ADVANCED_PHOTON_BLASTERS: ItemVariantData(ProtossItemType.Variants, 3),
    item_names.SCOUT_RESOURCE_EFFICIENCY: ItemVariantData(ProtossItemType.Variants, 4),
}

all_variant_item_data = {
    # v3 variant
    1: v3_variant_item_data,
}
