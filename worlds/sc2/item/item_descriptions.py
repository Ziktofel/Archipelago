...
item_descriptions = {
    ...
    item_names.ORACLE_STASIS_CALIBRATION: "Oracle War Council upgrade. Enemies caught by the Oracle's Stasis Ward may now be attacked for first 5 seconds of the duration of the effect.",
...
V3_DESCRIPION_PREFIX = '(v3 variant)'
v3_variant_descriptions = {
    item_names.GHOST_RESOURCE_EFFICIENCY: f"{V3_DESCRIPION_PREFIX} " + _get_resource_efficiency_desc(item_names.GHOST, op_re_cost_reduction),
    item_names.SPECTRE_RESOURCE_EFFICIENCY: f"{V3_DESCRIPION_PREFIX} " + _get_resource_efficiency_desc(item_names.SPECTRE, op_re_cost_reduction),
    item_names.DESTROYER_REFORGED_BLOODSHARD_CORE: f"{V3_DESCRIPION_PREFIX} Destroyer War Council upgrade. Destroyers do full damage to secondary targets when fully charge.",
    item_names.ORACLE_STASIS_CALIBRATION: f"{V3_DESCRIPION_PREFIX} Oracle War Council upgrade. Enemies caught by the Oracle's Stasis Ward may now be attacked for full duration of the effect.",
    item_names.REAVER_RESOURCE_EFFICIENCY: f"{V3_DESCRIPION_PREFIX} " + _get_resource_efficiency_desc(item_names.REAVER, op_re_cost_reduction),
    item_names.SCOUT_RESOURCE_EFFICIENCY: f"{V3_DESCRIPION_PREFIX} " + _get_resource_efficiency_desc(item_names.SCOUT, op_re_cost_reduction),
    item_names.SCOUT_ADVANCED_PHOTON_BLASTERS: f"{V3_DESCRIPION_PREFIX} Scouts, Oppressors and Mist Wings gain increased damage against ground targets. Scouts do double damage to ground light targets.",
}

all_variant_descriptions = {
    # v3 variant
    1: v3_variant_descriptions,
}
